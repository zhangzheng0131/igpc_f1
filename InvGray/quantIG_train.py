...
class Trainer:
    ...
    def _train_epoch(self, epoch):
        ...
        for batch_idx, sample_batch in enumerate(self.train_loader):
            ...
            data = {'target_color':input_colors, 'pred_color':pred_colors, 'pred_gray':pred_grays}
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config_path', type=str, default='./quantIG_script.json', help='path of configure file')
