...
class Trainer:
    ...
    def _train(self):
        ...
        for epoch in range(self.start_epoch, self.n_epochs):
            ...
            if epoch < 5:
                self.decoder.module.setFrozeLayers()
            else:
                self.decoder.module.releaseFrozeLayers()
    ...
    def _train_epoch(self, epoch):
        ...
        self.encoder.train()
        if epoch < 5:
            self.decoder.module.train(with_frozenLayers=True)
        else:
            self.decoder.module.train(with_frozenLayers=False)
        st = time.time()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config_path', type=str, default='./quantPCIG2_script.json', help='path of configure file')
